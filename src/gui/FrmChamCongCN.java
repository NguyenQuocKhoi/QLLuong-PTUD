...
//		scrollPane_1.setViewportView(table_1);
		...
		lblNgayCham = new JLabel("Ngày Chấm: ");
		lblNgayCham.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		lblNgayCham.setBounds(1270, 109, 98, 29);
		add(lblNgayCham);
	...
	private void capNhatLuong() {
		...
		try {
			...
			for (ChamCongCN cc : listCC) {
				...
				double luong = cc.getSoSP() * cc.getMaPC().getCDSX().getGia() + cc.getMaCa().getLuongTheoCa()
						+ cc.getMaPC().getMaCN().getTroCap();
