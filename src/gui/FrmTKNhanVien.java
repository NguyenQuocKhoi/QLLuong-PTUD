...
public class FrmTKNhanVien extends JPanel implements ActionListener {
	...
	public FrmTKNhanVien() {
		...
		btnTK.setBounds(605, 82, 143, 35);
		add(btnTK);

		btnIn = new JButton("In");
		btnIn.setIcon(new ImageIcon("hinh\\iconIn.png"));
		btnIn.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		btnIn.setBounds(833, 82, 105, 35);
		add(btnIn);

		btnTK.addActionListener(this);
		btnIn.addActionListener(this);

		JLabel lblTienLuongNN = new JLabel("Tiền lương thấp nhất:  ");
		...
		lbLTN.setBounds(399, 167, 185, 21);
		add(lbLTN);

		JLabel lblTienLuongCaoNhat = new JLabel("Tiền lương cao nhất: ");
