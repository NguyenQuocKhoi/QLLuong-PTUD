...
//		scrollPane_1.setViewportView(tableTK);
		...
		btnXuatExcel.setBounds(1009, 81, 170, 35);
		add(btnXuatExcel);

		btnXuatExcel.addActionListener(this);
		
		btnTopCN = new JButton("DS Công nhân xuất sắc");
		btnTopCN.setFont(new Font("Times New Roman", Font.PLAIN, 17));
		btnTopCN.setBounds(985, 151, 194, 29);
		add(btnTopCN);
