...
//		tableCDSX.addMouseListener(this);
		...
		lblCngonCn = new JLabel("Công đoạn cần làm trước:");
		lblCngonCn.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		lblCngonCn.setBounds(169, 273, 219, 29);
		add(lblCngonCn);
		updateTableData();
		updateCBSP();
		refreshMaCD();
