...
//		}
	...
	private boolean valiData() {
		...
		LocalDate ngayCham = LocalDate.parse(txtNgay.getText(), DateTimeFormatter.ofPattern("yyyy-MM-dd"));
		...
		if (ngayCham.isBefore(LocalDate.now())) {
			thongbaoLoi(txtNgay, "Ngày phân công không hợp lệ!");
			return false;
		}
//		if (ngayCham.isAfter(LocalDate.now())) {
//			thongbaoLoi(txtNgay, "Ngày chấm không hợp lệ!");
//			return false;
//		}
		return true;
	}
